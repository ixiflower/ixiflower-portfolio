...
import { personalData, experience, courses } from "@/lib/data";
...
const highlights = [
  ...
  },
  {
    icon: Zap,
    label: "Currently",
    value: "OWASP Zero — Voorivex Academy",
  },
  {
    icon: BookOpen,
    label: "Hobby",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          >
            ...
            {/* Course list */}
            <div className="pt-4">
              <h3 className="text-sm font-mono text-accent tracking-widest uppercase mb-4">
          ...
          >
            <div className="grid grid-cols-1 gap-4">
              {highlights.map((item) => (
                <div
                  key={item.label}
                  className="glass rounded-xl p-5 flex items-start gap-4 group hover:bg-card-hover transition-colors duration-300"
                >
